        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center space-x-12">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/favorites" className="text-sm font-medium text-gray-600 hover:text-blue-600 transition-colors">
                Favoritter
              </Link>
              <Link href="/messages" className="text-sm font-medium text-gray-600 hover:text-blue-600 transition-colors">
                Beskeder
              </Link>
            </div>
          </div>
